...
The highest optimism-corrected AUROC was achieved by Model A2 which included both all nine clinical variables from the SCORE2-Diabetes input predictors and the CGM-derived metrics TIR and MAGE (AUROC: 0.81 [0.77–0.88]).
