...
::: {#tbl-excluded2  tbl-colwidths="\[80, 20\]" fig-scap='Excluded studies.'}
...
# Study I: Clinical and Subclinical Results {#sec-suppl-subclin-results}
...
Study design and demographics of the clinical outcome studies.
...
Study design, demographics, and adjustments of the subclinical outcome studies.

:::
:::
:::

{{< include app1-clin-tbl.qmd >}}

{{< include app1-subclin-tbl.qmd >}}

# Study I: Adjustment List {#sec-suppl-adjustment-list}
...
**Anthropometric**
(Variables that describe body size or composition)
...
**Physiological**
(Vital signs or systemic functions)
...
**Biochemical**
(Blood/urine analytes, metabolic markers)
...
::: {#tbl-cosim-race-ntprobnp tbl-pos="H"}

```{=latex}
   \begin{table}[H]
      \begin{tabular}{l|rr|rr}
         \toprule
                                 & \multicolumn{2}{c|}{Within-participant}& \multicolumn{2}{c}{Between-participant} \\
         Group                   & n         & Median {[}IQR{]}           & n          & Median {[}IQR{]}           \\\midrule
         Normal NT-proBNP        & 5415      & 0.058 {[}0.040, 0.084{]}   & 507163     & 0.123 {[}0.078, 0.191{]}   \\
         Elevated NT-proBNP      & 4044      & 0.058 {[}0.040, 0.084{]}   & 270867     & 0.109 {[}0.073, 0.168{]}   \\
         Across NT-proBNP groups &           &                            & 751646     & 0.116 {[}0.076, 0.180{]}   \\
         Non-Hispanic Black      & 165311    & 0.066 {[}0.047, 0.094{]}   & 34151640   & 0.085 {[}0.059, 0.128{]}   \\
         Non-Hispanic White      & 186287    & 0.063 {[}0.046, 0.086{]}   & 33982718   & 0.079 {[}0.056, 0.117{]}   \\
         Different groups        &           &                            & 34230775   & 0.083 {[}0.058, 0.123{]}  \\\toprule
      \end{tabular}
   \end{table}

```
Cosim distances for within and between participants for NT-proBNP and race.
...
::: {#fig-pred-stability fig-scap='Prediction stability plots'}
...
::: {#tbl-seg-white tbl-colwidths="[12,18,15,9,9,9,9,9,10]" fig-scap='Surveillance Error Grid for non-Hispanc White participants.'}
...
::: {#tbl-seg-black tbl-colwidths="[12,18,15,9,9,9,9,9,10]" fig-scap='Surveillance Error Grid for non-Hispanc Black participants.'}
