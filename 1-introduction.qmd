...
With the guidelines recommendation of using \acr{HbA1c}, a debate has sparked on the controversy of using a set threshold as it is well known that racial differences in HbA1c exists.[@Selvin2013]
...
The \acr{CGM} devices measures the glucose in the interstitial fluid, which corresponds with plasma glucose although a lag can appear when glucose levels rise or fall rapidly.[@ADA2026_ch7]
...
Association and prediction are distinct analytical objectives, although the terms are sometimes used interchangeably in the medical literature. This distinction is important because associations do not necessarily imply predictive utility.[@TiborVarga2020] Association studies aim to identify relationships between variables and an outcome at group level, whereas prediction models are developed to estimate future outcomes for individual patients.[@TiborVarga2020]
...
The prediction models are fitted to data (the predictors) and the output $Y´$ is evaluated based on the outcome $Y$, [@Breiman2001] and evaluation metrics on prediction studies often include classification metrics such as \acr{AUROC}, sensitivity, specificity and calibration plots[@VanCalster2025] or correlation coefficients, and \acr{RMSE}, for forecasting models.[@vanDoorn2021]
...
There is still a lack of reporting on race and ethnicity in trials even though diabetes affects individuals across all racial and ethnic groups and differences have been reported in glycemic response, glycemic control, insulin resistance and the burden of diabetes-related complications between populations.[@Turner2022; @Muralidharan2024; @Danielson2010; @doVale2021; @Bergenstal2017 @Selvin2013; @Kirk2006; @ADA2026_ch2]
