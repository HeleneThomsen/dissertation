...
##  Cardiovascular Clinical Prediction Models
...
Evaluation metrics on prediction studies often include classification metrics such as \acr{AUROC}, sensitivity, specificity and calibration plots[@VanCalster2025] or correlation coefficients, and \acr{RMSE}, for forecasting models.[@vanDoorn2021]
...
Machine learning is often associated with complex algorithms that are hard to interpretate, but many machine learning methods are closely related to familiar statistical approaches.[@Badillo2020] Similarly, linear regression can be applied in a data-driven modelling framework and are among the most interpretable machine learning methods.[@Badillo2020]
