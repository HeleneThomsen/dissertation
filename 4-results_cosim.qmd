...
::: {#fig-cosim_umap fig-scap='UMAP projections of CGM embeddings by glycemic control'}
[![](figures/4_results_fig/study_2_co_sim_umaps.png)](https://raw.githubusercontent.com/HeleneThomsen/dissertation/main/figures/4_results_fig/study_2_co_sim_umaps.png)
    ...
    ```{=latex}
        \begin{table}[]
            \begin{tabular}{ccrrrr}
                                    ...
                                    & UMAP Dimension       & \multicolumn{1}{c}{ρ}       & \multicolumn{1}{c}{p-value}    & \multicolumn{1}{c}{ρ} & \multicolumn{1}{c}{p-value}\
                \multirow{2}{*}{HbA1c} & 1 & 0.48  & p<0.001 & 0.30 & p<0.001         \\
                                    & 2 & -0.65 & p<0.001 & 0.50  & p<0.001                     \\
                \multirow{2}{*}{TIR}   & 1 & 0.71  & p<0.001 & -0.39 & p<0.001                     \\
                                    & 2 & 0.81  & p<0.001 & -0.65 & p<0.001                     \\
        ...
        \begin{table}[]
            \begin{tabular}{llll}
                ...
                \multirow{2}{*}{CANCAN} & Within-participant pairs  & 9459     & 0.058 {[}0.040, 0.084{]} \\
                                        & Between-participant pairs & 1529676  & 0.117 {[}0.076, 0.182{]} \\
...
Cosine distance distributions for within- and between-participant pairs in CANCAN across glycemic targets (HbA1c <53 mmol/mol, TIR ≥70% or MAGE ≤3.9 mmol/L). Dashed lines show medians; shaded bands show interquartile ranges.
...
Cosine distance distributions for within- and between-participant pairs in T1DX across glycemic targets (HbA1c <53 mmol/mol, TIR ≥70% or MAGE ≤3.9 mmol/L). Dashed lines show medians; shaded bands show interquartile ranges.
...
% \usepackage{multirow}
    \begin{table}[]
        ...
        Metrics                & Group               & n                     & Median {[}IQR{]}         & n             & Median {[}IQR{]}              \\
        \multirow{3}{*}{\multicolumn{1}{c}{HbA1c}} & Low HbA1c           & 1707                  & 0.051 {[}0.037, 0.072{]} & 46809         & 0.085 {[}0.058, 0.135{]}      \\
        ...
        \multirow{3}{*}{\multicolumn{1}{c}{TIR}}   & High TIR            & 3509                  & 0.054 {[}0.038, 0.073{]} & 206119        & 0.076 {[}0.056, 0.104{]}      \\
        ...
        \multirow{3}{*}{\multicolumn{1}{c}{MAGE}}  & High MAGE           & 8750                  & 0.059 {[}0.041, 0.086{]} & 1310750       & 0.114 {[}0.075, 0.178{]}      \\
...
\begin{tabular}{llrrrr}
                       &                     & \multicolumn{2}{l}{Within-participant pairs}     & \multicolumn{2}{l}{Between-participants pairs} \\
...
\multirow{3}{*}{MAGE}  & High MAGE           & 348358                & 0.064 {[}0.047, 0.090{]} & 67192895       & 0.082 {[}0.057, 0.122{]}      \\
                       ...
                       & Across MAGE groups  & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-}    & 941463         & 0.093 {[}0.065, 0.135{]}     
\end{tabular}
\end{table}
```
-->
...
::: {#fig-cosim_ntprobnp fig-scap='UMAPs and kernel density plots grouped by HbA1c' width=100%}
::: {.content-visible when-format="html"}
[![](figures/4_results_fig/study_2_co_sim_cancan_gv.png)](https://raw.githubusercontent.com/HeleneThomsen/dissertation/main/figures/4_results_fig/study_2_co_sim_cancan_gv.png){width=100%}
:::
::: {.content-visible when-format="pdf"}
...
Cosine distance distributions for within- and between-participant pairs in CANCAN for NT-proBNP (Elevated NT-proBNP < 125 pg/mL). Dashed lines show medians; shaded bands show interquartile ranges.

:::


::: {#fig-cosim_race fig-scap='UMAPs and kernel density plots grouped by HbA1c' width=100%}
::: {.content-visible when-format="html"}
