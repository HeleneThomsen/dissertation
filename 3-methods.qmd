...
\tablenote[0.75\linewidth]{
    ...
    \textit{Abbreviations:} TIR = Time in Range; MAGE = mean amplitude of glycemic excursions.
}
```
...
::: {#fig-study3_rmse fig-scap='Linear mixed effect model hypotheses'}
...
::: {#fig-study3_SEG fig-scap='Surveillance error grid' width=80%}
![](figures/3_methods_fig/study3_SEG_empty.png){width=80%}
