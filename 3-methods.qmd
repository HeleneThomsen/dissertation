...
Embeddings are numerical vectors that summarize the characteristics of the input glucose profile. The CGMformer gives a 128-dimensional embedding vector for each 24-hour CGM data input. A simple vector can be drawn as an arrow in a 2-dimensional space as shown in @fig-cancan-embedding.
