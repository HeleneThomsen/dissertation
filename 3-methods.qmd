...
The two databases were selected because they are core databases for biomedical literature. Owing to the resources available to the review team, the search was not extended to additional databases.
The search strategy was developed in collaboration with information specialists.
An exploratory search was held and 13 studies within the field was identified and used to test the search strategy up against by ensuring the 13 identified studies were included in the final search.[@Foreman2021; @Yapanis2022; @Helleputte2022; @Lu2021; @Martinez2021; @Mita2023; @Lu2020; @Mo2013; @Wakasugi2021; @Magri2018; @Su2011; @Tang2016; @Zhang2013].
...
All identified records were uploaded into the software tool EPPI reviewer 6[@Thomas2023] and duplicates were removed. Titles and abstracts were screened by at least two independent reviewers and a meeting was held after \~5% of the titles and abstracts had been screened, to resolve disagreements and ensure consistency between reviewers. Afterwards full-text screening was performed by two independent reviewers and held up against eligibility criteria. Disagreements were resolved through discussion at physical meetings between reviewers.
...
::: {#nte-study1-research-q .callout-note appearance="simple" icon="false" border-left-color: #003D73;}

::: {.content-visible when-format="pdf"}
<!-- 
```{=latex}
    \begin{researchquestionbox}
        \textbf{\large Research Questions (Study I)}

        \begin{enumerate}
        \item Is there an association between glycemic control and CVD risk?
        \item Can CGM-derived metrics predict CVD risk?
        \item What CGM-derived metrics are used in the literature?
        \item Which cardiovascular markers and diseases are included as outcomes in the studies?
        \item What characterizes study populations (age, sex, ethnicity, geographic location)?
        \item What study designs are used (e.g., longitudinal cohort studies, randomized controlled trials, cross-sectional studies)?
        \item How was data collected (e.g., clinical trial, epidemiological study, routinely collected data)?
        \item What CGM devices were used?
        \item What statistical models were used in the studies?
        \item Is the data openly available?
        \item Is the code openly available?
        \end{enumerate}
...
## Study Populations used in this thesis
