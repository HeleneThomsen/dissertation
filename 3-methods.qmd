...
: Overview of models and predictors {#tbl-prediction-models}
...
: Overview of the three studies included in this PhD {#tbl-overview-studies bl-lines="rows"} 
...
### Study II: Data and Participant Selection
...
### Predictors
- [ ] What is the SCORE2-diabetes and why was it chosen? (The Outcome + european dataset
)
...
Overview of models and predictors {#tbl-models}
